...
const INQUIRY_TYPES = [
  { key: 'inquiry', icon: <FiMessageSquare size={24} />, name: 'General Inquiry', desc: 'Questions about venues, availability, pricing, or how ShaadiGo works.' },
  { key: 'issue', icon: <FiAlertCircle size={24} />, name: 'Report an Issue', desc: 'Booking disputes, payment problems, venue inaccuracies, or platform errors.' },
  { key: 'feedback', icon: <FiStar size={24} />, name: 'Platform Feedback', desc: 'Share suggestions, improvements, or your overall experience with ShaadiGo.' },
];
          ...
          <div className="contact-sidebar">
            ...
            <div className="sidebar-card">
              <h3 style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <FiPhoneCall /> Other Ways to Reach Us
              </h3>
              {[
                { icon: <FiSmartphone size={18} />, label: 'Phone', value: '+92 21 3456 7890', href: 'tel:+922134567890' },
                { icon: <FiMail size={18} />, label: 'Email', value: 'support@shaadigo.pk', href: 'mailto:support@shaadigo.pk' },
                { icon: <FiMessageCircle size={18} />, label: 'Live Chat', value: 'Available 9 AM – 9 PM', href: '#' },
                { icon: <FiMapPin size={18} />, label: 'Office', value: '12 MM Alam Rd, Lahore', href: '#' },
              ].map(c => (
